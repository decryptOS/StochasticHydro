...
def main() -> None:
    ...
    time_diff = time_diff[:n_min]*lam**2
    ...
    theory =  args.temp * args.mass_density* np.exp(-damp * time_diff/lam**2)

    theory2 =  args.temp * args.mass_density* np.exp(-0.229314 * (kx**2 + ky**2 + kz**2) * time_diff/lam**2)
    ...
    ax.set_xlabel("time difference t*Lam^2")
